...
st.title("Chest X-ray  Medical Report Generator for Tuberculosis")
st.markdown("<small>by Duncan and Ronald </small>",unsafe_allow_html=True)
#st.markdown("[Github](https://github.com/fastio19/Summarized-Medical-Report-Generation-on-Chest-X-Rays)")
st.markdown("\nThis app  generates the final impression of a Chest X-ray radiology medical report.\nYou can upload the Chest X-Ray Image and the corresponding report will be generated.")
